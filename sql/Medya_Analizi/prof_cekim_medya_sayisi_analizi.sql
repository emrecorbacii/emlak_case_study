...
GROUP BY profesyonel_cekim, medya_sayisi
ORDER BY profesyonel_cekim DESC, medya_sayisi;
-- Profesyonel cekim durumu ve toplam medya sayisina gore portfoy satis performansini karsılastırır.
-- Medya sayisi artisinin satis oranini nasil etkiledigini gosterir.
